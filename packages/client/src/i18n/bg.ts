...
export const bg = {
  ...
  'landing.privateRoomHint':'Покани приятели с код',
  'landing.searching':   'Търся играчи…',
  ...
  'lobby.botDifficulty': 'Сила на ботовете',
  'lobby.botDifficultyHint': 'Влияе на наддаването и играта на ботовете.',
  'lobby.botEasy':       'Леко',
  'lobby.botMedium':     'Средно',
  'lobby.botHard':       'Силно',
  'suit.NT.short':       'NT',
  'suit.AT.short':       'AT',
  ...
  'tour.players':        'Играчи',
  'tour.starts':         'Старт',
  'tour.statusUpcoming': 'Предстои',
  'tour.statusRegistration':'Запис',
  'tour.statusActive':   'Активен',
  'tour.statusFinished': 'Приключил',
  'tour.statusCancelled':'Отказан',
  'tour.regClose':       'Записът затваря',
  'tour.regOpen':        'Записът е отворен',
  'tour.regClosed':      'Записът е затворен',
  'tour.joinRequiresAuth':'Влез в профила си, за да се запишеш',
  'tour.full':           'Местата свършиха',
  'tour.signedUp':       'Записан си',
  'tour.signingUp':      'Записване…',
  'tour.create':         'Създай турнир',
  'tour.createTitle':    'Нов турнир',
  'tour.createName':     'Име',
  'tour.createSize':     'Размер',
  'tour.createStarts':   'Начало',
  'tour.createRegClose': 'Записът затваря',
  'tour.createSubmit':   'Създай',
  'tour.creating':       'Създаване…',
  'tour.seed':           'Стартирай турнира',
  'tour.seeding':        'Подготовка…',
  'tour.needPlayers':    'Минимум 2 играча',
  'tour.bracket':        'Bracket',
  'tour.participants':   'Участници',
  'tour.winner':         'Шампион',
  'tour.bye':            'Преминава',
  'tour.tba':            'TBA',
  'tour.playMatch':      'Играй мач',
  ...
  'mm.withBots':         'С ботове',
  'mm.withoutBots':      'Без ботове',
  'mm.waitHint':         'С ботове: ако не се съберат 4-ма души до 30 секунди, празните места се запълват с ботове. Без ботове: чака докато дойдат истински играчи.',
